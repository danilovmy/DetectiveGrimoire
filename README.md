...
Готовый файл находится в `installer/dist/Detective-Grimoire-RU-Installer.exe`. Скопируйте его в папку с `Detective Grimoire.exe` и запустите: он проверит поддерживаемую GOG-версию 1.2.0, создаст резервную копию и применит перевод. В EXE встроены только перевод и инструменты применения; игровых SWF, изображений, звука и исходных английских текстов в нём нет.
